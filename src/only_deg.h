...
double **LinkScoreMB_OD(struct node_gra *net,
		      ...
		      gsl_rng *gen,
		      char verbose_sw);
double ORPartitionHMB_OD(struct group *part, double linC, double *HarmonicList);
void ORLSMCStepMB_OD(int factor,
		double *H,
		double linC,
		struct node_gra **nlist,
		struct group **glist,
		...
		double *HarmonicList,
		gsl_rng *gen);
int ORGetDecorrelationStepMB_OD(double *H,
			   double linC,
			   struct node_gra **nlist,
			   struct group **glist,
			   struct group *part,
			   ...
			   gsl_rng *gen,
			   char verbose_sw);
void ORThermalizeLSMCMB_OD(int decorStep,
		      double *H,
		      double linC,
		      struct node_gra **nlist,
		      struct group **glist,
		      ...
		      gsl_rng *gen,
		      char verbose_sw);
double **ORLinkScoreMB_OD(struct node_gra *net,
		      double linC,
		      int nIter,
		      gsl_rng *gen,
		      char verbose_sw);
...
double **GibbsLinkScoreMB_OD(struct node_gra *net,
			...
			gsl_rng *gen,
			char verbose_sw);
void ORGibbsLinkScoreStepMB_OD(double *H,
			double linC,
			struct node_gra **nlist,
			struct group **glist,
			struct group *part,
			...
			double *HarmonicList,
			gsl_rng *gen);
void ORGibbsThermalizeLinkScoreMB_OD(double *H,
			      double linC,
			      struct node_gra **nlist,
			      struct group **glist,
			      struct group *part,
			      ...
			      gsl_rng *gen,
			      char verbose_sw);
double **ORGibbsLinkScoreMB_OD(struct node_gra *net,
			double linC,
			int nIter,
			gsl_rng *gen,
			char verbose_sw);
