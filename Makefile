...
test : main_test.c libgraph.a
	...
	-L${PRNGDIR}/lib/ -L./ -lprng -lgraph -lm ${DEBUG_FLAG}
...
tools.o : tools.c tools.h
	gcc -c tools.c ${DEBUG_FLAG}

graph.o : graph.c graph.h tools.h
	gcc -c graph.c -I${PRNGDIR}/include ${DEBUG_FLAG}

modules.o : modules.c modules.h tools.h
	gcc -c modules.c -I${PRNGDIR}/include ${DEBUG_FLAG}
